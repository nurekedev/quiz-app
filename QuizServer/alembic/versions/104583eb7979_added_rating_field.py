...
Revision ID: 104583eb7979
Revises: 7309741c0ee9
Create Date: 2025-07-27 03:24:14.561668
...
revision: str = "104583eb7979"
down_revision: Union[str, None] = "7309741c0ee9"
...
def upgrade() -> None:
    ...
    op.add_column("quiz_results", sa.Column("rating", sa.Float(), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column("quiz_results", "rating")
